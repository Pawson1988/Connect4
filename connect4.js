...
for(let i = 0; i < boxes.length; i++){
    boxes[i].onclick = () => {
        if(boxes[i + 7].classList.contains("taken") && !boxes[i].classList.contains("taken")){
                if (currentPlayer == 1){
                    boxes[i].classList.add("taken");
                    boxes[i].classList.add("player-one");
                    currentPlayer = 2;
                    displayCurrentPlayer.textContent = currentPlayer;
                    checkBoard();
            }   else if (currentPlayer == 2){
                    boxes[i].classList.add("taken");
                    boxes[i].classList.add("player-two");
                    currentPlayer = 1;
                    displayCurrentPlayer.textContent = currentPlayer;
                    checkBoard();
            } else {
...
>>>>>>> 4f8da603875253f4b67fe6cd3115bceeec8ed209
})